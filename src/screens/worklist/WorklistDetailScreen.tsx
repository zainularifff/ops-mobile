    ...
    >
      ...
      <View style={styles.profileCard}>
        <View style={styles.profileTop}>
          <View style={[styles.profileIcon, { backgroundColor: typeColor }]}>
        ...
        <Text style={styles.profileDesc}>{item.reason}</Text>
      </View>

      <View style={styles.infoPanel}>
        <Text style={styles.panelTitle}>Action Item Information</Text>

        <InfoRow icon={Tag} label="Source" value={item.source || "-"} color={typeColor} />
        <InfoRow icon={MapPin} label="Site" value={item.site || "-"} color={typeColor} />
        <InfoRow icon={UserRound} label="Owner" value={item.owner || "-"} color={typeColor} />
        <InfoRow icon={Clock3} label="Due" value={item.due || "-"} color={typeColor} />
      </View>
...
{/* 
      <TouchableOpacity
        style={[styles.webButton, { backgroundColor: typeColor }]}
        activeOpacity={0.85}
      >
